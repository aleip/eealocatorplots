...
`r curgas` emissions from source category *`r cursec` Enteric Fermentation* are `r percent(eushareghg,1)` of total `r eukp` GHG emissions and `r percent(eusharech4)` of total `r eukp` `r curgas` emissions. They make `r percent(eushareagrighg,1)` of total agricultural emissions. It is thus the largest GHG source in agriculture and the largest source of `r curgas` emissions. The main sub-categories are `r subcateg$sector_number[1]` (`r subcateg$category[1]`) and `r subcateg$sector_number[2]` (`r subcateg$category[2]`) as shown in `r figs("fig3.Ashare",display="cite")`.
`r text2sharems(sec=cursec)`


`r figs("fig3.Ashare",display="full")`

![](../../../../../google/projects/ecir/plots/20170317agrimixeu3.A.jpg)

`r figs("fig3.Asharems",display="full")`

![](../../../../../google/projects/ecir/plots/20170317emissionshare_3.A.jpg)
...
![](../2016/eureport/20170317/Table3AEntericFermentation.jpg)
...
![](../2016/eureport/20170317/Table3A1CattleCH4.jpg)
...
![](../2016/eureport/20170317/Table3A2SheepCH4.jpg)
...
![](../../../../../google/projects/ecir/plots/20170317/valueadem/3AFarming-EntericFermentationCH4EM-nirvalue.jpg) 
...
The main driver for the decrease of CH4 emissions from enteric fermentation was the decrease in animal numbers shown in `r figs(paste0("fig","Dairy Cattle","trend",curmea),display="cite")` and `r figs(paste0("fig","Non-Dairy Cattle","trend",curmea),display="cite")`.
...
![](../../../../../google/projects/ecir/plots/20170317/valueadem/3A1DairyCattle-EntericFermentationCH4EM-nirvalue.jpg) 

`r figs(paste0("fig","Non-Dairy Cattle","trend","EM"),display="full")`

![](../../../../../google/projects/ecir/plots/20170317/valueadem/3A1Non-DairyCattle-EntericFermentationCH4EM-nirvalue.jpg) 

`r figs(paste0("fig","Dairy Cattle","trend","POP"),display="full")`

![](../../../../../google/projects/ecir/plots/20170317/valueadem/3A1DairyCattle-EntericFermentationPOP-nirvalue.jpg) 

`r figs(paste0("fig","Non-Dairy Cattle","trend","POP"),display="full")`

![](../../../../../google/projects/ecir/plots/20170317/valueadem/3A1Non-DairyCattle-EntericFermentationPOP-nirvalue.jpg) 
...
![](../../../../../google/projects/ecir/plots/20170317/valueadem/3A2Sheep-EntericFermentationCH4EM-nirvalue.jpg) 

`r figs(paste0("fig",cursec,"trend","POP"),display="full")`

![](../../../../../google/projects/ecir/plots/20170317/valueadem/3A2Sheep-EntericFermentationPOP-nirvalue.jpg) 
...
![](../../../../../google/projects/ecir/plots/20170317/rangeief/3A1DairyCattle-EntericFermentationIEF-nirrange.jpg) 
...
`r text2ief(fig=figs("figA11trendgeav",display="cite"),tab=tabs("tabA11geav",display="cite"))` Data from Luxembourg are reported in a different unit and are therefore not included in this comparison.

`r figs("figA11trendgeav",display="full")`

![](../../../../../google/projects/ecir/plots/20170317/rangeief/3A1DairyCattle-EntericFermentationGE-nirrange.jpg)
...
![](../../../../../google/projects/ecir/plots/20170317/rangeief/3A1DairyCattle-EntericFermentationMilk-nirrange.jpg) 
...
![](../../../../../google/projects/ecir/plots/20170317/rangeief/3A1Non-DairyCattle-EntericFermentationIEF-nirrange.jpg)
...
![](../../../../../google/projects/ecir/plots/20170317/rangeief/3A1Non-DairyCattle-EntericFermentationGEav-nirrange.jpg)
...
![](../../../../../google/projects/ecir/plots/20170317/rangeief/3A2Sheep-EntericFermentationIEF-nirrange.jpg) 
...
![](../../../../../google/projects/ecir/plots/20170317/rangeief/3A2Sheep-EntericFermentationGEav-nirrange.jpg)
