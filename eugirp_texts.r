...
colexpl3<-paste0("# resolved-flag: 0=not resolved - 1=resolved - ",
                 ...
                 "# explanation date and source: meta information about the issue: what is the explanation-when has it been ",
                 "solved and what was the source of information")
potsignNE<-paste0("According to our information there are methods from the 2006 IPCC Guidelines to estimate these emissions.",
               "Please provide justification that emissions from the source category for which you use the notation key 'NE' ",
               "is not linked to a potential underestimation of GHG emissions.",
               "To do so, please check if the not-estimated emissions can be argued to be below the threshold of significance, ",
               "which is 0.05% of national total GHG emissions and does not exeed 500 kt CO2 eq. ",
               "Method a -  You might provide a plausible upper estimate of the AD (i.e. very unlikely that the AD level is larger) ",
               "and multiply it with the default EF to derive a likely level of emissions for the repective category. ",
               "Method b -  Alternatively you might calculate which AD level would imply that the respective emissions ",
               "reach the threshold of significance and provide evidence that the likely AD level is below that calculated value. ",
               "If you cannot provide a justification, the use of the NE notation key could lead to a technical ",
               "correction during the ESD review. ",
               "Note that The total national aggregate of estimated emissions for all gases and categories considered insignificant ",
               "shall remain below 0.1   per cent of the national total GHG emissions.")
potsign<-paste0("Please provide justification that the value used is appropriate and/or that is not linked to ",
                "a potential over- or underestimation of GHG emissions.",
                "To do so, please check that the difference to emissions estimated with IPCC default methodology ",
                "can be argued to be below the threshold of significance, ",
                "which is 0.05% of national total GHG emissions and does not exeed 500 kt CO2 eq. ",
                "If you cannot provide a justification, this could lead to a technical correction during the ESD review. ",
                "Note that the total national aggregate of estimated emissions for all gases and categories considered insignificant ",
                "shall remain below 0.1 per cent of the national total GHG emissions.")