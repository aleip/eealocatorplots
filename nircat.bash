...
if [ $focus == "last" ]; then
	cat nir0.Rmd ${unc} > nir${focus}out.Rmd
elif [ $focus == "faonir" ]; then
	cat nir0.Rmd nirfaocomparison.Rmd > nir${focus}out.Rmd
elif [ $focus == "all" ]; then
	cat nir0.Rmd nir3a.Rmd nir3b1.Rmd nir3b2.Rmd nir3d.Rmd ${unc} > nir${focus}out.Rmd
...
test -e nir${focus}out.Rmd && . nirpandoc.bash nir${focus}out
