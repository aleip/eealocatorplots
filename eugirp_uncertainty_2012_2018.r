...
# eugirp_uncertainty_2012_2018.r
#
# Created on: Summer 2018
#
# Created by: Xavier Rotllan-Puig (xavi.rotllan.puig@gmail.com)
#
# Description: The aim of this script is to read in and process all the 
#              emissions/uncertainties reported by the countries and aggregate them 
#              into categories (e.g. Enteric Fermentation, etc).
#              Data from 2012-2014 is not processed, since Adrian already had done it
#              previously. Data from 2015-2018 is processed here.
#              Some comments made by Adrian in an email (08/09/2018): "what i hoped for 
#              was that one can see an increase in uncertainty in some earlier years 
#              when countries do take more attention on it and understand the problems 
#              better, and then decreases when they start working on the problems. this 
#              is what i had seen 10 years ago. but the data don't show it. this means 
#              for me that the 'old data' are actually not so important any more and we
#              can focus on the year 2018 data."
#              Therefore, this script is "deprecated" and only saved to trace how the 
#              the data 2012-2018 has been processed. As of 2019, the script called
#              "eugirp_uncertainty.r" is the one to be used to process the new data sets.
# 
# Inputs:
#       - Emissions/Uncertainty data reported by the countries
#       
# 
# Outputs:
...
save(list = c("uncert_all", "EMagg", "EMagg_perc", "uEMagg"),
     file = paste0(invloc, "/uncertainty/uncert_all_2012_2018.RData"))
