...
Other source categories are not contributing to a key source analysis at `r eukp` level and are therefore not further discussed here. . Emissions from source category J - other agriculture emissions are reported only from Germany (digestion of energy crops) and the UK (emissions from liming in oversee territories and crown dependencies).
