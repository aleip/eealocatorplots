...
![]($eugirpplots$/$cursubm$agrimixeu3.B.2.jpg)

`r figs(paste0("fig",cursec,"sharems"),display="full")`

![]($eugirpplots$/$cursubm$emissionshare_3.B.2.jpg)

`r figs(paste0("fig","3.B.2.5","sharems"),display="full")`

![]($eugirpplots$/$cursubm$emissionshare_3.B.2.5.jpg)
...
![]($eugirpplots$/$cursubm$/valueadem/3B21DairyCattle-N2OandNMVOCEmissionsN2OEM-nirvalue.jpg) 

`r figs(paste0("fig3B212","trend",curmea),display="full")`

![]($eugirpplots$/$cursubm$/valueadem/3B21Non-DairyCattle-N2OandNMVOCEmissionsN2OEM-nirvalue.jpg) 
...
![]($eugirpplots$/$cursubm$/rangeief/3B21DairyCattle-N2OandNMVOCEmissionsIEF-nirrange.jpg) 
...
![]($eugirpplots$/$cursubm$/rangeief/3B21DairyCattle-N2OandNMVOCEmissionsNRATE-nirrange.jpg) 
...
![]($eugirpplots$/$cursubm$/rangeief/3B21Non-DairyCattle-N2OandNMVOCEmissionsIEF-nirrange.jpg) 
...
![]($eugirpplots$/$cursubm$/rangeief/3B21Non-DairyCattle-N2OandNMVOCEmissionsNRATE-nirrange.jpg) 
