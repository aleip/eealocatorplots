...
`r curgas` `r firstlow(capmeasure(curmeasure))` are `r percent(eushareghg,1)` of total `r eukp` GHG emissions and `r percent(eusharech4)` of total `r eukp` `r curgas` emissions. They make `r percent(eushareagrighg,1)` of total agricultural emissions. `r figs(paste0("fig",paste0(cursec,"Dairy Cattle"),"trendem"),display="cite")` and `r figs(paste0("fig",paste0(cursec,"Non-Dairy Cattle"),"trendem"),display="cite")` show the trend of emissions for Dairy and Non-Dairy Cattle indicating the countries contributing most to `r eusubml`.
